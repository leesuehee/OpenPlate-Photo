...
// try to refactor to render % sizes 
    ...
    if (photoLen <= 8 && photoLen !== 5 && photoLen !== 7) {
      return (
        ...
        if (photoLen === 5) {
          let styles1 = {position: 'absolute', top:'0px', left:'0px'}
          ...
          let styles5 = {position: 'absolute',top: '152px',left:'452px'}
            ...
            <div className = 'photogallery'>
              ...
              <div className = 'photo'>
                <div className = 'pic-wrapper' style = {styles1}>
                  <img className = 'pic' src = {pic[0].src} height = {hsize} width = {wsize}/>
              ...
              <div className = 'photo'>
                <div className = 'pic-wrapper'  style = {styles2}>
                  <img className = 'pic' src = {pic[1].src} height = {wsize} width = {wsize}/>
              ...
              <div className = 'photo'>
                <div className = 'pic-wrapper' style = {styles4}>
                  <img className = 'pic' src = {pic[3].src} height = {hsize} width = {wsize}/>
              ...
              <div className = 'photo'>
                <div className = 'pic-wrapper' style = {styles5}>
                  <img className = 'pic' src = {pic[4].src} height = {hsize} width = {wsize}/>
        ...
        //RETURN FOR 7
          ...
          let styles4 = {position: abs,top: zero,left:'365px'}
          let styles5 = {position: abs,top: '123px',left:'363px'}
          let styles6 = {position: abs,top: zero,left:'483px'}
          let styles7 = {position: abs,top: '123px',left:'482px'}
